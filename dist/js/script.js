...
/* harmony import */ var _modules_generalFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/generalFunctions */ "./src/js/modules/generalFunctions.js");
...
window.addEventListener('DOMContentLoaded', function () {
  const modalTimerId = setTimeout(() => Object(_modules_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["openModal"])('.modal', modalTimerId), 300000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-05-11');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-modal]', '.modal', modalTimerId);
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])('.menu .container');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _generalFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generalFunctions */ "./src/js/modules/generalFunctions.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(() => {
      ...
      Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["closeModal"])('.modal');
    }, 4000);
  }
}
...
/***/ "./src/js/modules/generalFunctions.js":
/*!********************************************!*\
  !*** ./src/js/modules/generalFunctions.js ***!
  \********************************************/
/*! exports provided: getZero, closeModal, openModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(btn => {
    btn.addEventListener('click', () => Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["openModal"])(modalSelector, modalTimerId));
  });
  modal.addEventListener('click', e => {
    if (e.target === modal || e.target.getAttribute('data-close') == "") {
      Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["closeModal"])(modalSelector);
    }
  });
  ...
  function showModalByScroll() {
    if (window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
      Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["openModal"])(modalSelector, modalTimerId);
...
/* harmony import */ var _generalFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generalFunctions */ "./src/js/modules/generalFunctions.js");
...
function slider({
  ...
  let slideIndex = 1;
  let offset = 0;
  total.textContent = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_1__["getZero"])(slides.length);
  current.textContent = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_1__["getZero"])(slideIndex);
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(t.days);
      hours.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(t.hours);
      minutes.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(t.minutes);
      seconds.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(t.seconds);

      if (t.total <= 0) {
        clearInterval(timeInterval);
        days.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(0);
        hours.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(0);
        minutes.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(0);
        seconds.innerHTML = Object(_generalFunctions__WEBPACK_IMPORTED_MODULE_0__["getZero"])(0);
      }
    }
  }
